function toggle( tabId ) {
	 ...
	 * @return {bool}
	 */
	function stringHas( haystack, subString ) {
		return -1 !== haystack.indexOf( subString );
	}
	...
	/**
	 * Does a string have a production TLD.
	 *
	 * @author Aubrey Portwood <code@aubreypwd.com>
	 * @since  1.0.0
	 * @param  {string} url URL
